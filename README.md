...
- **consistency.py** — Wraps the style in a consistent prefix and derives deterministic per-card seeds from a base seed.
- **generator.py** — Calls the Replicate API with retry logic, downloads images, and shows a progress bar. Supports sequential or parallel generation.
