...
DEFAULT_NEGATIVE = (
    ...
    "watermark, signature, writing, written text, inscriptions, captions, "
    "numbers, numerals, digits, logos, printed text, handwriting, calligraphy, "
    "lettering, any text whatsoever, "
